...
public class SellTicketTest {
	...
	public void sellTicket2() {
		SeatingClass sClass = SeatingClass.ECONOMY;
		PassengerName passengerName = new PassengerName("Aryan", "P", "Patel");
		StaffPassenger staff = new StaffPassenger(passengerName,"EMP123");
		Seat seat = new Seat();
		seat.setRow(3);
		seat.setLetter('B');
		double price = sClass.getPrice();
	...
	public void sellTicket3() {
		...
		PassengerName passengerName1 = new PassengerName("Aryan", "P", "Patel");
		StaffPassenger staff = new StaffPassenger(passengerName1,"EMP234");
		Seat seat = new Seat();
		seat.setRow(1);
		seat.setLetter('A');
		double price = sClass.getPrice();
